<div id="sidebar" class="sidebar py-3">
    ...
    <ul class="sidebar-menu list-unstyled">
        <li class="sidebar-list-item"><a href="{{ route('home.index') }}"
                                         class="sidebar-link text-muted {{ str_contains(Route::currentRouteName() , 'home') ? 'active' : '' }}"><i
        ...
        @endcan
        @can('is_admin')
        <li class="sidebar-list-item"><a href="{{ route('users.index') }}"
                                         class="sidebar-link text-muted {{ str_contains(Route::currentRouteName() , 'users') ? 'active' : '' }}"><i
                    class="fa fa-users mr-3 text-gray"></i><span>Users</span></a></li>
        @endcan
        <li class="sidebar-list-item"><a href="{{ route('front.index') }}" class="sidebar-link text-muted"><i
                    class="fa fa-eye mr-3 text-gray"></i><span>Pubic Magazines</span></a></li>


        <li class="sidebar-list-item"><a href="{{ route('my-account.index') }}"
