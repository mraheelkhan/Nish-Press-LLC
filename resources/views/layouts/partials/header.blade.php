            ...
            <li class="nav-item dropdown ml-auto">
                <a id="userInfo"
                   ...
                   class="nav-link dropdown-toggle">
                    <span class="img-fluid rounded-circle shadow">
                    <div class="icon text-white" style="background: #f87ca3;">{{ strtoupper(substr(auth()->user()->firstname, 0,1)) }}</div>
                    </span>
                    <div aria-labelledby="userInfo" class="dropdown-menu"><a href="#" class="dropdown-item">
                            <strong class="d-block text-uppercase headings-font-family"> {{ auth()->user()->firstname }} </strong>
                            <small></small>
                        </a>
{{--                        <div class="dropdown-divider"></div>--}}
{{--                        <a href="#" class="dropdown-item">Settings</a><a href="#" class="dropdown-item">Activity--}}
{{--                            log </a>--}}
{{--                        <div class="dropdown-divider"></div>--}}
